    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="${pageContext.request.contextPath}/admin-category?action=new" class="btn btn-primary fw-bold">
                        ...
                        <tbody>
                            <c:forEach var="cat" items="${listCategory}">
                                <tr>
                                    ...
                                    <td class="text-start text-muted">${cat.description}</td>
                                    <td>
                                        <c:choose>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin-category?action=edit&id=${cat.id}" class="btn btn-sm btn-outline-primary" title="Düzenle">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin-category?action=delete&id=${cat.id}" 
                                           class="btn btn-sm btn-outline-danger ms-1" 
                                           onclick="return confirm('Bu kategoriyi silmek veya pasife almak istediğinize emin misiniz?');" title="Sil / Pasife Al">
                            ...
                            <c:if test="${empty listCategory}">
                                <tr>
                                    <td colspan="5" class="text-center p-4 text-muted">Sistemde henüz kayıtlı kategori bulunmamaktadır.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
